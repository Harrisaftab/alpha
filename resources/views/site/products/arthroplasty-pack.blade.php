          ...
          <div class="col-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mt-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Arthroplasty-Pack</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="row product-item-single">
              <div class="col-sm-6">
                <div class="product__img">
                  <img src="{{ asset('web-assets/images/products/2.png') }}" class="zoomin" alt="product" loading="lazy">
                </div>
              </div>
              <div class="col-sm-6">
                <h1 class="product__title">Arthroplasty-Pack</h1>
            ...
            <div class="product__details mt-5">
              ...
              <div class="tab-content mb-50" id="nav-tabContent">
                <div class="tab-pane fade show active" id="Description">
                  <p>The Arthroplasty-Pack is a comprehensive, sterile delivery solution designed to support safe, 
                ...
                <div class="tab-pane fade" id="Details">
                  <p>The Arthroplasty-Pack includes high-quality, medical-grade items that meet strict clinical standards for 
